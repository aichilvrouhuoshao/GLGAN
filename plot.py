...
plt.grid(b = True, color = 'k', linestyle = '--', alpha = 0.2)#alpha is the transparency
...
plt.grid(b = True, color = 'w', linestyle = '-', alpha = 1)#alpha is the transparency

ax = plt.gca()
ax.patch.set_facecolor("gray") #set the color of playground
